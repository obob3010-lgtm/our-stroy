...
(() => {
  ...
  function initReason(){const r=$('reasonText'),b=$('reasonBtn'),c=$('reasonCount');const arr=['Потому что ты умеешь делать обычный день особенным.','Потому что рядом с тобой я становлюсь мягче.','Потому что у нас слишком много смешных историй, чтобы остановиться.','Потому что ты — человек, к которому хочется возвращаться.','Потому что мне нравится наше «мы»', 'Потому что от твоего «уммм, как вкусно» я готов скупить все десертные меню города.','Потому что ты умудряешься быть самым неуклюжим человеком на планете - и при этом самым моим.','Потому что на самокате ты держишься за меня так, будто боишься упасть, а я - самый счастливый водитель на свете.','Потому что после каждой нашей глупой драки понарошку ты всё равно первая смеёшься.','Потому что ты смотришь дорамы, которые я ненавижу всем сердцем, - а я смотрю их с тобой всем сердцем.','Потому что у тебя расширяются зрачки, и я вижу в них своё отражение - так меня ещё никто не видел.','Потому что ты - светик, который умеет быть светом даже в мой самый тёмный день.','Потому что удача, которая должна была достаться тебе, зачем-то перешла мне - но я всё равно рядом разгребать твои приключения.','Потому что «милая дверь» стала нашей дверью, а не просто кафе с клубничным десертом.','Потому что ты - пингвинёнок и гномик одновременно, и я обожаю фотографировать доказательства.','Потому что даже когда ты — ведьма и исчадие ада в 6 утра без кофе, я всё равно хочу быть рядом.','Потому что ты умеешь превращать парк аттракционов в лучший день лета даже после ссоры.','Потому что лодка на озере, честный разговор и твоя рука в моей - это ровно то, что я называю домом.','Потому что 51 шаг из 100 - это не предел, просто я всегда начинаю первым.','Потому что твоё «жоним» звучит теплее, чем любое другое слово, которое я знаю.','Потому что кроха, которая держит на себе половину моего мира, даже не подозревает, какая она сильная.','Потому что рядом с тобой даже плохой день выглядит терпимым.','Потому что ты моя Дильнурочка, и это единственное имя, которое хочется повторять просто так.','Потому что с тобой всё ощущается как «в первый раз».','Потому что я всё ещё помню тепло твоей головы у меня на плече на самокате.','Потому что буся - это не просто слово, это то, кем ты стала для меня.','Потому что твоя улыбка чинит мне настроение быстрее любого другого способа, который я пробовал.','Потому что я готов слушать твои дорамы хоть каждый вечер, лишь бы ты сидела рядом.','Потому что даже спустя месяц вдали я точно знаю: 10 августа, 10 утра — и я обниму тебя так, что мы оба забудем как дышать.',];let n=0;b?.addEventListener('click',()=>{r.textContent=arr[n++%arr.length];c.textContent=n});}
